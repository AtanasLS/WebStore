...
export class CheckoutPaymentComponent implements OnInit {
  ...
  constructor(private basketService: BasketService, private checkoutService: CheckoutService,
   ...
   ngOnInit(): void {
    loadStripe('pk_test_51P1A2I00oXaquZ67igfdbYOfHXlrfITU8sgmHxaNgfxNR5cruUehyUEGkGlxGhHu6EJD2eqF5onAwphUuVK1GeOm00ngbT5Z5r').then(stripe =>{
      this.stripe = stripe;
  ...
  private async confirmPaymentWithStripe(basket: Basket | null) {
    ...
    if(!result) throw new Error ('Problem attending payment with Stripe!');
